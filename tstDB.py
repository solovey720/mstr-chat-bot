...
class DB: 
    ...
    def insert_security (self, user_id, security):
        try:
            self.cursor.execute(
                '''
    ...
    def insert_favorite (self, user_id, favorite):
        try:
            self.cursor.execute(
                '''
    ...
    def insert_subscription (self, user_id, subscription={}):
        try:
            self.cursor.execute(
                '''
